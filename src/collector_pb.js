    ...
    lightstep.collector = (function() {
        ...
        collector.SpanContext = (function() {
            ...
            SpanContext.decode = function decode(reader, length) {
                ...
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lightstep.collector.SpanContext(), key;
            ...
            SpanContext.fromObject = function fromObject(object) {
                if (object instanceof $root.lightstep.collector.SpanContext)
                    return object;
                var message = new $root.lightstep.collector.SpanContext();
        ...
        collector.KeyValue = (function() {
            ...
            KeyValue.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lightstep.collector.KeyValue();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            KeyValue.fromObject = function fromObject(object) {
                if (object instanceof $root.lightstep.collector.KeyValue)
                    return object;
                var message = new $root.lightstep.collector.KeyValue();
                if (object.key != null)
        ...
        collector.Log = (function() {
            ...
            Log.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lightstep.collector.Log();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            Log.verify = function verify(message) {
                ...
                if (message.fields != null && message.hasOwnProperty("fields")) {
                    ...
                    for (var i = 0; i < message.fields.length; ++i) {
                        var error = $root.lightstep.collector.KeyValue.verify(message.fields[i]);
                        if (error)
                            return "fields." + error;
                    }
                }
            ...
            Log.fromObject = function fromObject(object) {
                if (object instanceof $root.lightstep.collector.Log)
                    return object;
                var message = new $root.lightstep.collector.Log();
        ...
        collector.Reference = (function() {
            ...
            Reference.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lightstep.collector.Reference();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            Reference.verify = function verify(message) {
                ...
                if (message.spanContext != null && message.hasOwnProperty("spanContext")) {
                    var error = $root.lightstep.collector.SpanContext.verify(message.spanContext);
                    if (error)
            ...
            Reference.fromObject = function fromObject(object) {
                if (object instanceof $root.lightstep.collector.Reference)
                    return object;
                var message = new $root.lightstep.collector.Reference();
        ...
        collector.Span = (function() {
            ...
            Span.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lightstep.collector.Span();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            Span.verify = function verify(message) {
                ...
                if (message.references != null && message.hasOwnProperty("references")) {
                    ...
                    for (var i = 0; i < message.references.length; ++i) {
                        var error = $root.lightstep.collector.Reference.verify(message.references[i]);
                        if (error)
                            return "references." + error;
                    }
                }
                if (message.startTimestamp != null && message.hasOwnProperty("startTimestamp")) {
                    var error = $root.google.protobuf.Timestamp.verify(message.startTimestamp);
                    if (error)
                ...
                if (message.tags != null && message.hasOwnProperty("tags")) {
                    ...
                    for (var i = 0; i < message.tags.length; ++i) {
                        var error = $root.lightstep.collector.KeyValue.verify(message.tags[i]);
                        if (error)
                            return "tags." + error;
                    }
                }
                if (message.logs != null && message.hasOwnProperty("logs")) {
                    ...
                    for (var i = 0; i < message.logs.length; ++i) {
                        var error = $root.lightstep.collector.Log.verify(message.logs[i]);
                        if (error)
                            return "logs." + error;
                    }
                }
            ...
            Span.fromObject = function fromObject(object) {
                if (object instanceof $root.lightstep.collector.Span)
                    return object;
                var message = new $root.lightstep.collector.Span();
                if (object.spanContext != null) {
                    if (typeof object.spanContext !== "object")
        ...
        collector.Reporter = (function() {
            ...
            Reporter.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lightstep.collector.Reporter();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            Reporter.fromObject = function fromObject(object) {
                if (object instanceof $root.lightstep.collector.Reporter)
                    return object;
                var message = new $root.lightstep.collector.Reporter();
        ...
        collector.MetricsSample = (function() {
            ...
            MetricsSample.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lightstep.collector.MetricsSample();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            MetricsSample.fromObject = function fromObject(object) {
                if (object instanceof $root.lightstep.collector.MetricsSample)
                    return object;
                var message = new $root.lightstep.collector.MetricsSample();
                if (object.name != null)
        ...
        collector.InternalMetrics = (function() {
            ...
            InternalMetrics.encode = function encode(message, writer) {
                ...
                if (message.gauges != null && message.gauges.length)
                    for (var i = 0; i < message.gauges.length; ++i)
            ...
            InternalMetrics.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lightstep.collector.InternalMetrics();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            InternalMetrics.verify = function verify(message) {
                ...
                if (message.counts != null && message.hasOwnProperty("counts")) {
                    ...
                    for (var i = 0; i < message.counts.length; ++i) {
                        var error = $root.lightstep.collector.MetricsSample.verify(message.counts[i]);
                        if (error)
                            return "counts." + error;
                    }
                }
                if (message.gauges != null && message.hasOwnProperty("gauges")) {
                    ...
                    for (var i = 0; i < message.gauges.length; ++i) {
                        var error = $root.lightstep.collector.MetricsSample.verify(message.gauges[i]);
                        if (error)
                            return "gauges." + error;
                    }
                }
            ...
            InternalMetrics.fromObject = function fromObject(object) {
                if (object instanceof $root.lightstep.collector.InternalMetrics)
                    return object;
                var message = new $root.lightstep.collector.InternalMetrics();
                if (object.startTimestamp != null) {
                    if (typeof object.startTimestamp !== "object")
                ...
                if (object.gauges) {
                    ...
                    message.gauges = [];
                    for (var i = 0; i < object.gauges.length; ++i) {
            ...
            InternalMetrics.toObject = function toObject(message, options) {
                ...
                if (message.gauges && message.gauges.length) {
                    object.gauges = [];
                    for (var j = 0; j < message.gauges.length; ++j)
        ...
        collector.Auth = (function() {
            ...
            Auth.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lightstep.collector.Auth();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            Auth.fromObject = function fromObject(object) {
                if (object instanceof $root.lightstep.collector.Auth)
                    return object;
                var message = new $root.lightstep.collector.Auth();
        ...
        collector.ReportRequest = (function() {
            ...
            ReportRequest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lightstep.collector.ReportRequest();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ReportRequest.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.reporter != null && message.hasOwnProperty("reporter")) {
                    var error = $root.lightstep.collector.Reporter.verify(message.reporter);
                    if (error)
                        return "reporter." + error;
                }
                if (message.auth != null && message.hasOwnProperty("auth")) {
                    var error = $root.lightstep.collector.Auth.verify(message.auth);
                    if (error)
                        return "auth." + error;
                }
                if (message.spans != null && message.hasOwnProperty("spans")) {
                    ...
                    for (var i = 0; i < message.spans.length; ++i) {
                        var error = $root.lightstep.collector.Span.verify(message.spans[i]);
                        if (error)
                            return "spans." + error;
                    }
                }
                ...
                if (message.internalMetrics != null && message.hasOwnProperty("internalMetrics")) {
                    var error = $root.lightstep.collector.InternalMetrics.verify(message.internalMetrics);
                    if (error)
            ...
            ReportRequest.fromObject = function fromObject(object) {
                if (object instanceof $root.lightstep.collector.ReportRequest)
                    return object;
                var message = new $root.lightstep.collector.ReportRequest();
        ...
        collector.Command = (function() {
             ...
             * @property {boolean|null} [devMode] Command devMode
             */
             ...
             * @instance
             */
            Command.prototype.devMode = false;
            ...
            Command.encode = function encode(message, writer) {
                ...
                if (message.devMode != null && message.hasOwnProperty("devMode"))
                    writer.uint32(/* id 2, wireType 0 =*/16).bool(message.devMode);
                return writer;
            };
            ...
            Command.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lightstep.collector.Command();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            Command.fromObject = function fromObject(object) {
                if (object instanceof $root.lightstep.collector.Command)
                    return object;
                var message = new $root.lightstep.collector.Command();
        ...
        collector.ReportResponse = (function() {
            ...
            ReportResponse.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lightstep.collector.ReportResponse();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ReportResponse.verify = function verify(message) {
                ...
                if (message.commands != null && message.hasOwnProperty("commands")) {
                    ...
                    for (var i = 0; i < message.commands.length; ++i) {
                        var error = $root.lightstep.collector.Command.verify(message.commands[i]);
                        if (error)
                ...
                if (message.transmitTimestamp != null && message.hasOwnProperty("transmitTimestamp")) {
                    var error = $root.google.protobuf.Timestamp.verify(message.transmitTimestamp);
                    if (error)
            ...
            ReportResponse.fromObject = function fromObject(object) {
                if (object instanceof $root.lightstep.collector.ReportResponse)
                    return object;
                var message = new $root.lightstep.collector.ReportResponse();
                if (object.commands) {
